        ...
        for pred_name in missing_adds:
            ...
            for i, action in enumerate(new_actions):
                ...
                if possible:
                    ...
                    # We can only check if the predicate is fundamentally inconsistent
                    # (e.g. if we add P, does it have Not(P))?
                    ...
                    # For simplicity, let's assume if the action unconditionally deletes
                    # a matching predicate type, avoid it.
