...
def test_n_domain_fusion(tmp_path):
    ...
    d1_path.write_text("(define (domain d1) (:requirements :strips) (:action a1 :parameters () :precondition () :effect ()))")
    
    d2_path = tmp_path / "d2_n.pddl"
    d2_path.write_text("(define (domain d2) (:requirements :strips) (:action a2 :parameters () :precondition () :effect ()))")
    
    d3_path = tmp_path / "d3_n.pddl"
    d3_path.write_text("(define (domain d3) (:requirements :strips) (:action a3 :parameters () :precondition () :effect ()))")
