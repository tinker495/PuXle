...
class TestPDDLWrapper:
    ...
    def test_grounded_atoms(self, puzzle):
        ...
        expected_atoms = [
            "(at loc1)", "(at loc2)", "(at loc3)",
            "(connected loc1 loc1)", "(connected loc1 loc2)", "(connected loc1 loc3)",
            "(connected loc2 loc1)", "(connected loc2 loc2)", "(connected loc2 loc3)",
            "(connected loc3 loc1)", "(connected loc3 loc2)", "(connected loc3 loc3)"
        ]
    ...
    def test_grounded_actions(self, puzzle):
        ...
        expected_parameters = [
            ['loc1', 'loc1'], ['loc1', 'loc2'], ['loc1', 'loc3'],
            ['loc2', 'loc1'], ['loc2', 'loc2'], ['loc2', 'loc3'],
            ['loc3', 'loc1'], ['loc3', 'loc2'], ['loc3', 'loc3']
        ]
        ...
        for expected_params in expected_parameters:
            ...
            for action in puzzle.grounded_actions:
                if (action['name'] == 'move' and 
                    action['parameters'] == expected_params):
                    found = True
                    break
